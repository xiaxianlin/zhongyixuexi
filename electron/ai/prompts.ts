/**
 * Prompt templates (AI-01). The red-line System Prompt fragment itself lives
 * in shared/core/ai/red-line.ts (layer 1 of the three-layer guard; layers 2/3
 * are shared/core/ai/guard.ts) and is re-exported here for existing callers.
 *
