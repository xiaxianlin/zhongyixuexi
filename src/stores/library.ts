/**
 * Library detail store (Zustand) — Model + Controller for BookDetailView.
 *
 * Per CLAUDE.md: persisted data always lives in SQLite; this store holds only
 * session/UI cache for the currently open book detail. Components read state
 * and dispatch actions from here; they do not call IPC directly.
 *
...
import { compactAnalysisText, flattenChapters } from '@/modules/library/helpers'
