/**
 * ProviderEditorModal — global component: the single reusable dialog for adding
 * OR editing an AI provider credential (SET-01).
 *
 * Used in two places:
 *  1. SettingsView: "编辑" opens it in create/edit mode — dismissable
 *     (Esc / backdrop / cancel); the key is optional on create.
 ...
 * pre-fills from the selected provider and keeps the existing key when the
 * field is left blank.
 */
