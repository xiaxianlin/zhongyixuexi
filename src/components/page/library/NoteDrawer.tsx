/**
 * NoteDrawer — notes overlay (business component, page-level) for the selected
 * paragraph. Reads notes/notesLoading/noteDrawerOpen from the store and
 * dispatches setNoteDrawerOpen / setDeleteTarget.
 */
import { useLibraryStore } from '@/models/library/store'
import { splitIntoColumns } from '@/models/library/helpers'
