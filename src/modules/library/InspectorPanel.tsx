/**
 * Right column of BookDetailView — the "析" (analysis) inspector. Shows the
 * selected paragraph's interpretation (modern / explanation / analysis) and
 * the AI generate button. Reads selectedParagraph/aiGenerating from the store
 * and dispatches requestAnalysis.
 */
import { useLibraryStore } from '@/stores/library'
import { compactAnalysisText, formatMedicalExplanation } from './helpers'
