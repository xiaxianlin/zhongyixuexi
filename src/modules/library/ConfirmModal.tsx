/**
 * Generic confirmation modal used by BookDetailView for delete-note and
 * re-analyze flows. Stateless — all behavior is passed via props so the parent
 * (store) owns the open/busy state.
 */
