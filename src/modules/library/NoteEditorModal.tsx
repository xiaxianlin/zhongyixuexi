/**
 * Note editor modal — textarea for drafting a note on the selected paragraph.
 * Reads noteDraftContent/noteSaving/noteModalOpen/selectedParagraphId from the
 * store and dispatches setNoteDraftContent / setNoteModalOpen / createParagraphNote.
 *
