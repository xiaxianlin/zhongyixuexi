 ...
 * the header + 3-column workspace + modals + toast from single-responsibility
 * sub-components.
 *
 * State and business logic live in useLibraryStore (Model/Controller); this
 * file is purely the View.
 */
